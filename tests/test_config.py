...
def test_install_docs_copies_readme_and_syntax_to_target_directory(tmp_path):
    from flegmcnf.docs import install_docs
    ...
    assert "FlegmCNF" in (target / "README.md").read_text(encoding="utf-8")
